...
const PlayerTimeline = () => {
  ...
  const handleClick: MouseEventHandler<HTMLDivElement> = (e) => {
    const cursorPosPercentage = ((e.pageX - e.currentTarget.offsetLeft) / e.currentTarget.clientWidth) * 100;
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.timeline} onClick={handleClick} onTouchMove={handleTouchMove}>
