...
const AppRouteName = ({ component, name }: { component: React.ReactElement; name: RoutesNamesEnum }) => {
  const routeName = useRouteName();

  return <UiConditionalRender condition={routeName === name}>{component}</UiConditionalRender>;
};
