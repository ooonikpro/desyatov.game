  ...
  return (
    <>
      <UiConditionalRender condition={isShow}>
        <div
          className={cn(s.root, { [s.animated]: isAnimated })}
          onTransitionEnd={() => setIsShow(false)}
        >
          <UiVideoBg src="assets/videos/intro.mp4" className={s.video} />

          <div className={s.content}>
            <h2 className={s.title}>
              Сделай свое тело здоровым и{" "}
              <span className={s.primary}>сильным</span>
            </h2>
            <p className={s.text}>
              спорт — это вид физической активности, направленный на развитие
              физических способностей и навыков.
            </p>
